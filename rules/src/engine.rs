...
pub fn navigator_default_rules() -> Vec<Box<dyn Rule>> {
    use crate::{
        ...
        F117GlossaryBackedCustomText, F118QuestionnaireLinearity, M001HeadingIncrement,
...
/// states (`N115`), and every custom question is defined (`N104`, in
/// questionnaire-only mode — a GitHub notation renders a body and stops, so
...
/// is not applied here.
const GITHUB_NOTATION_RULE_CODES: &[&str] = &["N101", "N103", "N104", "N113", "N115", "N118"];
...
mod tests {
    ...
    const EXPECTED_DEFAULT_RULE_CODES: &[&str] = &[
        ...
        "N109", "N110", "N112", "N113", "N114", "N115", "N116", "N117", "N118", "E002", "M001",
        "M003", "M004", "M005", "M007", "M009", "M010", "M011", "M012", "M018", "M019", "M020",
        "M021", "M022", "M023", "M024", "M025", "M026", "M027", "M028", "M029", "M030", "M031",
        "M032", "M034", "M035", "M037", "M038", "M039", "M040", "M042", "M045", "M046", "M047",
        "M048", "M049", "M050", "M051", "M052", "M053", "M054", "M055", "M056", "M057", "M058",
        "M059", "M060", "M061",
    ];
