...
2. **Template** — a versioned Markdown blueprint such as `onboarding__engagement_letter`.
...
```text
aida_create_notation(template_code="onboarding__engagement_letter", project_id=<sample-litigation project id>)
```
