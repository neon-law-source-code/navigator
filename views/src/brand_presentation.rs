...
pub const PALETTE: &[Palette] = &[
    ...
    // Slate. The least branded face in the family on purpose — the
    ...
    Palette {
        ...
        light: PaletteScheme {
            primary: "#2F4550",
            primary_hover: "#23343c",
            primary_active: "#1a262c",
            on_primary: "#ffffff",
            on_brand: "#ffffff",
            link: "#2F4550",
            link_hover: "#1a262c",
            surface_subtle: "#eef4f6",
            bg: None,
            surface: None,
            surface_raised: None,
            text: None,
        ...
        dark: PaletteScheme {
            primary: "#7ea2b4",
            primary_hover: "#92b0bf",
            primary_active: "#a5beca",
            on_primary: "#0d1117",
            on_brand: "#0d1117",
            link: "#7ea2b4",
            link_hover: "#92b0bf",
            surface_subtle: "#16252d",
            bg: None,
            surface: None,
            surface_raised: None,
            text: None,
