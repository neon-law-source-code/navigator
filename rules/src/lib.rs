...
pub fn description_for_code(code: &str) -> &'static str {
    match code {
        ...
        "N110" => {
            "Notation template must live on the catalog shelves or as a Project templates/<code>.md, and declare jurisdiction"
        }
        ...
        "N123" => {
            "Agreement, will, pleading, and closing-letter bodies must carry a Harvard \
