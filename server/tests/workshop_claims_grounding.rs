...
const WELCOME_TO_NEON_LAW: &str = "server/content/workshops/navigator/WELCOME_TO_NEON_LAW.md";

/// Every deck the loader publishes, so another cannot be added without
