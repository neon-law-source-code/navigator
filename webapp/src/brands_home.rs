...
pub struct BrandCard {
    ...
    pub has_logo: bool,
    /// Production website line: a compiled `www` host, or `No public host`
    /// for a runtime row.
    pub website: String,
...
pub async fn brands_home_view() -> Result<BrandsHomeView, ServerFnError> {
    ...
    for brand in brands {
        ...
        cards.push(BrandCard {
            ...
            website: crate::brand_website::BrandWebsite::from_key(&brand.key).host_line(),
    ...
    let cards = view.cards.iter().map(|c| {
        ...
        rsx! {
            article {
                ...
                p { class: "brands-home__card-host", "{c.website}" }
...
mod tests {
    ...
    fn lists_a_brand_row_with_its_owner_font_and_logo_status() {
        let html = render(vec![BrandCard {
            ...
            has_logo: false,
            website: "www.neonlaw.com".to_string(),
    ...
    #[test]
    fn summons_names_its_public_www_host() {
        let html = render(vec![BrandCard {
        ...
        assert!(html.contains("www.summonsdefense.nyc"), "{html}");
    }
    ...
    fn a_firm_scoped_brand_names_its_owning_firm() {
        let html = render(vec![BrandCard {
            ...
            has_logo: true,
            website: "No public host".to_string(),
        ...
        assert!(html.contains("No public host"), "{html}");
    }
