...
chain natively. The binding engagement letter is `templates/notations/neon_law/onboarding.md`.
...
**3. The workflow edge** — the one-line YAML change in `templates/notations/neon_law/onboarding.md`, routing the
...
- Step kind / status table: `workflows::step` and [`docs/notation-authoring.md`](notation-authoring.md) (the `onchain__`
  row).
- Engagement surface: `templates/notations/neon_law/onboarding.md` (the binding engagement letter).
