...
`onboarding__letter`. The `portal::retainer_walk` walker, the [`docs/retainer_intake.md`](retainer_intake.md)
...
[`Kind::opens_a_matter`](../rules/src/kind.rs). The shipped sample is the onboarding letter
