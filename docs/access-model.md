...
same `/app/admin` route bypass as the people directory; Lawyer and Clerk stay denied. Owner edits a
...
DRI may change that Firm's typeface and palette from the closed catalogs, and replace its logo and uploaded
