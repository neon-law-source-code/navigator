...
two answers of one type distinct — `entity__company` and
...
[`lsp/`](https://github.com/neon-law-source-code/navigator/tree/main/lsp) docs: VS Code, Neovim,
Helix, Emacs, Zed. The authoring loop for a non-engineer legal author:
