...
code: business__dpa_us
jurisdiction: US
respondent_type: person_and_entity
confidential: false
origin_url: https://github.com/General-Legal/legal-templates/tree/main/templates/dpa-us
prompts:
...
<!--
Drafting note: Complete all schedules and verify the applicable state laws, service-provider restrictions,
sensitive data, subprocessors, audit rights, and actual controls. This U.S. version supplies no international
transfer mechanism. Adapted from General Legal’s CC0 template at revision
...
## VII. Return, deletion, and priority
