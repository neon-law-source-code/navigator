...
A brand crate owns that face outright: its marketing copy (the English catalog under `locales/en/<brand-key>/`), its
page compositions, and its path table all live in the crate whose binary publishes them. See
