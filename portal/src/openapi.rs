    ...
    json!({
                ...
                "schema": {
                  ...
                  "properties": {
                    ...
                    "kind": {
                      ...
                      "enum": ["letter", "filing", "will", "trust", "directive", "agreement", "pleading", "onboarding", "offboarding", "memo", "transcript", "inbound_contract", "certificate_of_naturalization", "exhibit", "closed_repository", "invoice", "unclassified"]
                    },
      ...
      "components": {
        ...
        "schemas": {
          ...
          "SeedReport": {
            "type": "object",
            "required": ["model", "created", "updated", "unchanged", "records"],
            "properties": {
              "model": { "type": "string" },
              ...
              "records": {
                ...
                "items": {
                  ...
                  "properties": {
                    "key": { "type": "string" },
                    "action": { "type": "string", "enum": ["new", "unchanged", "changed"] },
