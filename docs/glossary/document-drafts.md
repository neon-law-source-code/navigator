...
description: >-
  The workflow prefix document_drafts is a system wait state for web-rendered review-document rows,
  used by workflows that generate multiple client-reviewable instruments.
---
