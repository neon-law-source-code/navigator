...
Read [`docs/vibe-coding.md`](../../../docs/vibe-coding.md),
...
- Build at the mounted base path, use `import.meta.env.BASE_URL`, and run the repository's lint, typecheck, tests, and
  build before review.
- Fixtures, copy, screenshots, issues, and agent transcripts use firm-owned or synthetic content only. Never include
  client data, party or matter names, legal files, real contact details, or production identifiers.
