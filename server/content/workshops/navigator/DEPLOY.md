...
| `delete-your-data` web port | `NAVIGATOR_LOCAL_DELETE_YOUR_DATA_PORT` | `3011`; `web` binds it alongside `PORT`, so the house brand is reachable with no `Host:` header trickery |
