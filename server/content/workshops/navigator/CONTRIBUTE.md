...
**Maintain a brand catalog**

Each public brand keeps its English home and services copy in `neon/locales/en/<brand-key>`; the registered catalogs are
`neon/`, `delete-your-data/`, and `lawyer-shook/`. A new catalog must be added through the brand registry with covering
tests and attorney review for public legal copy.
