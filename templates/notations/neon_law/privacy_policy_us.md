...
code: business__privacy_policy_us
jurisdiction: US
respondent_type: person_and_entity
confidential: false
origin_url: https://github.com/General-Legal/legal-templates/tree/main/templates/privacy-policy-us
prompts:
...
<!--
Drafting note: Reconcile every schedule with actual collection, vendors, sale/sharing, retention, tracking,
audience ages, state applicability, and rights tooling. This is a drafting template; no company privacy
practice is pre-certified. Adapted from General Legal’s CC0 template at revision
...
## VIII. Children, links, and changes
